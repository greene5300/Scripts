#Disables Windows Feedback Experience
    ...
    Set-ItemProperty $registryOEM  ContentDeliveryAllowed -Value 1 
    Set-ItemProperty $registryOEM  OemPreInstalledAppsEnabled -Value 1 
    Set-ItemProperty $registryOEM  PreInstalledAppsEnabled -Value 1 
    Set-ItemProperty $registryOEM  PreInstalledAppsEverEnabled -Value 1 
    Set-ItemProperty $registryOEM  SilentInstalledAppsEnabled -Value 1 
    Set-ItemProperty $registryOEM  SystemPaneSuggestionsEnabled -Value 1          
